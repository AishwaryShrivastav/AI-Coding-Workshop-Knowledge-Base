...
A running list of questions from participants and topics worth revisiting. We add to this over time — one entry at a time.

**How to use this doc:**
- Big questions get their own guide in [`/guides`](../guides). They're listed here with a link.
- Small questions and clarifications are answered inline below.
- Got a doubt? Add it under "Open questions" and we'll answer it.

---

## Answered — full guides
...
## Answered — quick notes

*Short answers live here. None yet — they'll be added as questions come in.*

<!--
Template for a quick note:

### Q: <the question>
<plain-English answer in a few lines>
-->
...
*Concepts worth a second pass. Add anything that felt rushed in the room.*
